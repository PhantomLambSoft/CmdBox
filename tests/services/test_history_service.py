...
class TestHistoryService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.service = HistoryService(repo=self.repo, get_settings=self.get_settings)
    ...
    def test_get_recent_delegates_to_repository(self):
        ...
        self.repo.get_recent.assert_called_once_with("deploy", 5)
    ...
    def test_get_by_ref_with_numeric_ref_uses_index_lookup(self):
        ...
        self.assertEqual(expected, actual)
        self.repo.get_recent.assert_called_once_with(alias="deploy", limit=1)
    ...
    def test_get_by_ref_with_id_uses_repository_get_by_id(self):
        ...
        self.assertEqual(expected, actual)
        self.repo.get_by_id.assert_called_once_with("abc123")
    ...
    def test_get_by_index_raises_when_index_exceeds_available_entries(self):
        ...
        self.repo.get_recent.assert_called_once_with(alias="ops", limit=2)
    ...
    def test_get_by_index_returns_matching_one_based_entry(self):
        ...
        self.repo.get_recent.assert_called_once_with(alias=None, limit=2)
    ...
    def test_delete_by_ref_resolves_entry_and_deletes_by_id(self):
        ...
        actual = self.service.delete_by_ref("to-delete")

        self.assertEqual(True, actual)
        self.repo.get_by_id.assert_called_once_with("to-delete")
        self.repo.delete_by_id.assert_called_once_with("to-delete")
    ...
    def test_delete_by_ref_with_numeric_reference_deletes_index_entry(self):
        ...
        actual = self.service.delete_by_ref("1")

        self.assertEqual(True, actual)
        self.repo.get_recent.assert_called_once_with(alias=None, limit=1)
        self.repo.delete_by_id.assert_called_once_with("index-entry")

    def test_clear_delegates_to_repository_with_alias(self):
        self.repo.clear.return_value = 3

        actual = self.service.clear(alias="deploy")

        self.assertEqual(3, actual)
        self.repo.clear.assert_called_once_with(alias="deploy")
    ...
    def test_clear_delegates_to_repository_without_alias(self):
        ...
        self.repo.clear.assert_called_once_with(alias=None)
